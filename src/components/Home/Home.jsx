...
import { ArrowRight, Download, Github, Facebook, Twitter } from '../icons/Icons';
            ...
            <div className="home__text">
                <div className="home__text--container">
                    ...
                    <h1 className="home__title">
                        ...
                        <span className="home__title--description">A frontend web developer</span>
                    </h1>
                    <p className="home__text--description">This guy believes that on the seventh day, God created Code. He is also a , part time cyclist and proffesional dreamer</p>
