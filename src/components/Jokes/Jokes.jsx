...
const Jokes = () => {
    const jokes = [
        ...
        },
        {
            ...
            jokeAnswer: "Try it out in Internet Explorer. Did it work? No? It’s HTML5"
        },
        {
            jokeMain: "A programmer's wife tells him: \"While you're at the store, get some milk\".",
    ...
    return(
        <section className='jokes-section'>
            ...
            <Carousel itemsToShow={2}>
                { jokes.map((el, i) => <Joke joke={el.jokeMain} punchline={el.jokeAnswer} />) }
            </Carousel>
